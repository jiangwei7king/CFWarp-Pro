...
wget -6 -N --no-check-certificate https://raw.githubusercontent.com/YG-tsj/CFWarp-Pro/main/5multi.sh && chmod +x 5multi.sh && ./5multi.sh
}

function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/YG-tsj/CFWarp-Pro/main/5multi.sh && chmod +x 5multi.sh && ./5multi.sh
}
