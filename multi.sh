...
function start_menu(){
    ...
    blue " 虚拟架构类型 -$vi "
    rred " -----------------------------------------------" 
    white " 详细说明 https://github.com/YG-tsj/CFWarp-Pro  YouTube频道：甬哥探世界 " 
    
    white " 切记：进入脚本快捷方式 bash multi.sh "
    
    rred " ==========================一、VPS状态调整选择（更新中）==========================================" 
    ...
    yellow " 以下脚本已添加端口临时开启功能，重启VPS实例可还原初始设置 "
